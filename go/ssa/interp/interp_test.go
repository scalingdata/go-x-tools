...
func run(t *testing.T, dir, input string, success successPredicate) bool {
	...
	hint = fmt.Sprintf("To dump SSA representation, run:\n%% go build github.com/scalingdata/go-x-tools/cmd/ssadump && ./ssadump -test -build=CFP %s\n", input)
	...
	hint = fmt.Sprintf("To trace execution, run:\n%% go build github.com/scalingdata/go-x-tools/cmd/ssadump && ./ssadump -build=C -run --interp=T %s\n", input)
