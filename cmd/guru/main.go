...
//
package main // import "github.com/scalingdata/go-x-tools/cmd/guru"
...
The -json flag causes guru to emit output in JSON format;
	github.com/scalingdata/go-x-tools/cmd/guru/serial defines its schema.
...
Example: describe syntax at offset 530 in this file (an import spec):
  ...
  $ guru describe src/github.com/scalingdata/go-x-tools/cmd/guru/main.go:#530
`
