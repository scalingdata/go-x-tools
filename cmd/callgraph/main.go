...
package main // import "github.com/scalingdata/go-x-tools/cmd/callgraph"
...
import (
	...
	"github.com/scalingdata/go-x-tools/go/callgraph/static"
...
-format    Specifies the format in which each call graph edge is displayed.
           One of:
            ...
            digraph     output suitable for input to
                        github.com/scalingdata/go-x-tools/cmd/digraph.
...
Examples:
  ...
  Show all functions directly called by the callgraph tool's main function:
    ...
    callgraph -format=digraph github.com/scalingdata/go-x-tools/cmd/callgraph |
      digraph succs github.com/scalingdata/go-x-tools/cmd/callgraph.main
`
